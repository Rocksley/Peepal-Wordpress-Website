...
function eleos_register_meta_boxes( $meta_boxes ) {
	...
	$meta_boxes[] = array(
		...
		'fields'   => array(	
			array(
                'name' => 'Select Position Text on Image',
                'desc' => 'Select Position Text on Image, Default: Text on Left, Display on home page.',
                'id'   => $prefix . 'text_position',
                'type'    => 'select',
                'options' => array(
					'left' => 'Text on Left Image',
					'right' => 'Text on Right Image',                       
				),
				'std' => 'left'	
            )
		),
